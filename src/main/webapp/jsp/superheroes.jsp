<%-- 
    ...
    Created on : Oct 18, 2018, 1:50:26 PM
    Author     : tgraves
--%>
                ...
                <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <select multiple class="form-control" name="powers">
                                        <option selected disabled>Select Multiple Superpowers</option>
                    ...
                    <div id="editSuperheroDiv" class="col-md-6" style="display: none">
                        ...
                        <form class="form-horizontal" role="form" method="POST" action="editPerson">
                            ...
                            <div class="form-group">
                                <label class="col-md-4 control-label">Current Powers:</label>
                                <div class="col-md-8">
                                    <textarea class="form-control" rows="3" id="currentPowers" disabled></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="edit-superpowers" class="col-md-4 control-label">Superpowers:</label>
                                <div class="col-md-8">
                                    <select multiple class="form-control" name="powers">
                                        <option selected disabled>Select Multiple Superpowers</option>
                                        <!-- GET SUPERPOWERS FROM DB AND DISPLAY HERE -->
